...
import type { DogProps } from "@/components/DogCard";
import { useTranslations } from "next-intl";


export default function DogEditModal({ dog }: { dog: DogProps }) {
    const t = useTranslations("dashboard.dogs.editModal");
    ...
    return (
        <>
            ...
            >
                <Pencil className="w-5 h-5" /> {t("trigger")}
            </button>
